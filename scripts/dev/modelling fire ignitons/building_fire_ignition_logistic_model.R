...
ggplot(this_fire_dat_logit_model1_vars, aes(x=mean_wind_direction, y=ave_wind_speed, color=fire_ignition_day)) +
  geom_point() + xlab("average wind direction") +  ylab("average daily wind speed")
...
this_fire_dat_logit_model1_vars_lst$test$fire_ignition_day_model_prob <- stats::predict(model_1.3, this_fire_dat_logit_model1_vars_lst$test[, c("ERC")], type="response")
